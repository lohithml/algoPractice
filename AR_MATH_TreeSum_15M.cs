using LohiLibrary.Classes.LC.amz;
using System;
...
{
    public class AR_MATH_TreeSum_15M
    {
        //This is usually follw up question for 2 sum
        //Medium
        //15
        //3Sum
        ...
        //Time: O(N*N) 2 sum is O(N), 2 sum is run N times makes it O(N*N)
        //Space: O(N) ignoring space for output
    }
}